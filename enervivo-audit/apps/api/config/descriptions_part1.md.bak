...
**⚠️ DISAMBIGUÏSATION CRITIQUE LOI vs PDB — règle de décision** :
Si le document est **court (1-3 pages, .jpg/.png/.pdf 1 page)** ET contient une formule du type
« Proposition de partenariat », « Offre de partenariat », « Lettre d'intention »,
« Proposition pour signature d'une promesse de bail » → c'est **LOI signée** (Avant J1),
**JAMAIS PDB signée**. La PDB est un acte de **25-30 pages** intitulé en majuscules
« PROMESSE DE BAIL EMPHYTÉOTIQUE » avec une table des matières en 11 Articles.
La mention « promesse de bail » dans une LOI désigne le FUTUR acte, pas le document
lui-même. Mots-clés LOI à privilégier : « Offre_… », « LOI_… », « Lettre d'intention »,
